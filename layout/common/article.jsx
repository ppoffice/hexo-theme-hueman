          ...
          <article
                  ...
                  {page.date && (
                    <span
                      ...
                      dangerouslySetInnerHTML={{
                        __html: _p(
                          'article.created_at',
                          `<time dateTime="${date_xml(page.date)}" title="${date_xml(
                            page.date,
                          )}">${date(page.date)}</time>`,
                        ),
                      }}></span>
                  ...
                  {page.updated && (
                    <span
                      ...
                      dangerouslySetInnerHTML={{
                        __html: _p(
                          'article.updated_at',
                          `<time dateTime="${date_xml(page.updated)}" title="${date_xml(
                            page.updated,
                  ...
                  {article && article.readtime && article.readtime === true ? (
                    <span class="level-item">
                      {(() => {
                        ...
                        return `${_p(
                          'article.read_time',
                          time.locale(index ? indexLaunguage : language).humanize(),
            ...
            {!index && page.tags && page.tags.length ? (
              <div class="article-tags is-size-7 mb-4">
                ...
                {page.tags.map((tag) => {
                  return (
                    <a class="link-muted mr-2" rel="tag" href={url_for(tag.path)}>
                      {tag.name}
                    </a>
                  );
                })}
